...
if (!function_exists('getAuthRoleIds')) {
     ...
     * 
     * @param int $uid 用户 id,用于指定需要获取角色的用户 如果为 0,则表示获取当前会话用户的角色
     * @param string $field 指定返回角色的字段名,默认为'role_id',即角色 id
...
if (!function_exists('getAuthRoles')) {
     ...
     * @param int $uid 用户ID,默认为0,如果为0,则表示获取当前会话用户的角色
     * @param string $field 可选参数,用于指定返回角色的特定字段,如果为空,则返回所有字段
